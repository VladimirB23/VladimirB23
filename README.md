<div id="header" align="center">
  <img src="https://media4.giphy.com/media/v1.Y2lkPTc5MGI3NjExcHJqdTVyOHl1NXdhYTk0d3oxNTg0ZHYybXZhZjR2YndqemxyZzB4aCZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/NTtoU4hkyq8W48re2f/giphy.gif" width="500"/>
</div>
...
|[Автоматизированный отчет для анализа пролонгации проектов](https://github.com/VladimirB23/Project_2/tree/main)|подгрузка данных по API, предобработка данных, построение выборок, формирование базы проектов по месяцам, выделение данных для расчёта CR1 и CR2, поиск и устранение багов, расчет ключевых метрик, визуализация, фнукция по автоматизации сбора данных, годовые агрегаты, экспорт в Google Sheets и Excel|**Python: pandas, numpy, re** **Google Colab** **Google Sheets API**|
|[Дашборд для анализа пролонгации проектов Yandex Datalens](https://datalens.yandex/33aukc9gsjrso)|Подключение к Google Sheets API, анализ показателей пролонгации (CR1 и CR2) в разрезе по месяцам и году, по менеджерам и всему отделу, верстка дашборда, документация в отдельной вкладке |**Yandex Datalens**|
|[Дашборд для Анализа удовлетворенности покупателей в Yandex Datalens](https://datalens.yandex/7nmphwfyddtet)|Подключение к БД, анализ удовлетворенности и эффективности товаров и брендов в интернет-магазине косметики, верстка дашборда, документация в отдельной вкладке |**Yandex Datalens**|
